...
Console.WriteLine("=== BackendAPI Database Migration Tool ===");
Console.WriteLine();
...
static async Task SeedDataAsync(ApplicationDbContext context)
{
    ...
    var users = new[]
    {
        new BackendAPI.Data.Entities.User
        {
            Username = "admin",
            Email = "admin@example.com",
            PasswordHash = BackendAPI.Shared.Utilities.PasswordHasher.HashPassword("admin123"),
        ...
        new BackendAPI.Data.Entities.User
        {
            ...
            PasswordHash = BackendAPI.Shared.Utilities.PasswordHasher.HashPassword("test123"),
            FullName = "Test User",
            IsActive = true
        }
    };
    ...
    var products = new[]
    {
        new BackendAPI.Data.Entities.Product
        {
            Name = "Laptop",
